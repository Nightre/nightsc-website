...
import ClickToPlayVideo from "../../../components/ClickToPlayVideo.astro";
...
<ClickToPlayVideo src="/videos/martix-stack.mp4" label="播放矩阵堆栈演示视频" />
...
<ClickToPlayVideo src="/videos/build-step.mp4" label="播放构建步骤演示视频" />
...
<ClickToPlayVideo src="/videos/walk-subtree.mp4" label="播放子树遍历演示视频" />
